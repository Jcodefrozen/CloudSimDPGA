...
public class ReadConfigures {
     ...
     * @param testCaseNum the number of test cases. Start from testCaseNum[0] to testCaseNum[1]
     * @return
     */
    public ArrayList<ArrayList> testCases(String folderPath, String item, int[] testCaseNum){
